...
int TEST_MAIN()
{
    try {
        ...
        test(__LINE__, {"a", "c"},  test_active{1,0,0,0,0,0});
        test(__LINE__, {"a", "d"},  test_active{1,0,0,0,0,0});
        test(__LINE__, {"a", "e"},  test_active{1,0,0,0,0,0});

        test(__LINE__, {"b", "a"},  test_active{1,1,0,0,0,0});
        test(__LINE__, {"c", "a"},  test_active{1,0,0,0,0,0});
        test(__LINE__, {"d", "a"},  test_active{1,0,0,0,0,0});
        test(__LINE__, {"e", "a"},  test_active{1,0,0,0,0,0});

        test(__LINE__, {"f", "b"},  test_active{0,1,0,0,0,1});
        test(__LINE__, {"f", "c"},  test_active{0,0,0,0,0,1});
        test(__LINE__, {"f", "d"},  test_active{0,0,0,0,0,1});
        test(__LINE__, {"f", "e"},  test_active{0,0,0,0,0,1});

        test(__LINE__, {"b", "f"},  test_active{0,1,0,0,0,1});
        test(__LINE__, {"c", "f"},  test_active{0,0,0,0,0,1});
        test(__LINE__, {"d", "f"},  test_active{0,0,0,0,0,1});
        test(__LINE__, {"e", "f"},  test_active{0,0,0,0,0,1});

        test(__LINE__, {"a", "f", "b"},  test_active{1,1,0,0,0,1});
        test(__LINE__, {"a", "f", "c"},  test_active{1,0,0,0,0,1});
        test(__LINE__, {"a", "f", "d"},  test_active{1,0,0,0,0,1});
        test(__LINE__, {"a", "f", "e"},  test_active{1,0,0,0,0,1});

        test(__LINE__, {"a", "b", "f"},  test_active{1,1,0,0,0,1});
        test(__LINE__, {"a", "c", "f"},  test_active{1,0,0,0,0,1});
        test(__LINE__, {"a", "d", "f"},  test_active{1,0,0,0,0,1});
        test(__LINE__, {"a", "e", "f"},  test_active{1,0,0,0,0,1});

        test(__LINE__, {"f", "a", "b"},  test_active{1,1,0,0,0,1});
        test(__LINE__, {"f", "a", "c"},  test_active{1,0,0,0,0,1});
        test(__LINE__, {"f", "a", "d"},  test_active{1,0,0,0,0,1});
        test(__LINE__, {"f", "a", "e"},  test_active{1,0,0,0,0,1});
        ...
        test(__LINE__, {"b", "c", "f", "a"},           test_active{1,1,1,0,0,1});
        test(__LINE__, {"b", "c", "d", "f", "a"},      test_active{1,1,1,1,0,1});
        test(__LINE__, {"b", "c", "d", "e", "f", "a"}, test_active{1,1,1,1,1,1});

        test(__LINE__, {"b", "c", "a", "f"},           test_active{1,1,1,0,0,1});
        test(__LINE__, {"b", "c", "d", "a", "f"},      test_active{1,1,1,1,0,1});
        ...
        test(__LINE__, {"c", "b"},           test_active{0,1,0,0,0,0});
        test(__LINE__, {"d", "b"},           test_active{0,1,0,0,0,0});
        test(__LINE__, {"e", "b"},           test_active{0,1,0,0,0,0});
        test(__LINE__, {"c", "d", "b"},      test_active{0,1,0,0,0,0});
        test(__LINE__, {"b", "d", "c"},      test_active{0,1,1,0,0,0});
        test(__LINE__, {"b", "c", "e", "d"}, test_active{0,1,1,1,0,0});
        test(__LINE__, {"b", "d", "c", "e"}, test_active{0,1,1,0,0,0});

        test(__LINE__, {"b", "d"}, test_active{0,1,0,0,0,0});
        test(__LINE__, {"b", "e"}, test_active{0,1,0,0,0,0});

        test(__LINE__, {"c", "d"}, test_active{});
        test(__LINE__, {"c", "e"}, test_active{});
        test(__LINE__, {"d", "c"}, test_active{});
        test(__LINE__, {"d", "e"}, test_active{});
        test(__LINE__, {"e", "d"}, test_active{});
        test(__LINE__, {"e", "c"}, test_active{});
    }
